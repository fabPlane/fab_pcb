...
import { CommonCommandsLibraryTableScope as LibraryTableScope, FootprintMountingStyle, KiCadObjectType, type SchematicSymbol as SchematicSymbolDefinition } from '@fp-pcb/proto';
