...
`position`. Pin positions are library-relative by default (API semantics since upstream KiCad
`3cbac44524`: `SCH_PIN::Serialize` uses `GetLocalPosition()`); set `symbolPinsAbsolute: true` for
pins already in sheet coordinates (older servers, or symbols the caller transformed itself). Instance fields (`referenceField`, `valueField`, ..., `userFields`) are in absolute sheet
...
| `itemBBox(id)`                         | bbox lookup for group outlines                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `symbolPinsAbsolute`                   | default false (library coordinates); true = pins in sheet coordinates                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
