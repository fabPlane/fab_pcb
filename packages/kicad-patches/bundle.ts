...
console.log(
  `FabPlane PCB bundle: ${output} (${basename(cli)}, ${await countLibraries(footprints, ".pretty")} footprint libraries, ${await countLibraries(symbols, ".kicad_sym")} symbol libraries${fabRouterSource ? ", fab_router included" : ""})`,
);
